...
(function ($) {
     ...
     *
     * Sample usage for a bundles/log_body.properties bundle:
     * $.i18n.properties({
     *      name:      'log_body',
     *      language:  'en_US',
     *      path:      'bundles'
     * });
     * @param  name      (string/string[], optional) names of file to load (eg, 'log_body' or ['Msg1','Msg2']). Defaults to "log_body"
    ...
    $.i18n.properties = function (settings) {
        ...
        files.forEach(function (file) {
            ...
            // 1. load base (eg, log_body.properties)
