...
public:
  ...
  */
  ...
  //zhl  1
  void setData(const std::vector<double> &keys, const std::vector<double> &values, bool alreadySorted = false);
  ...
  //zhl 1
  void addData(const std::vector<double> &keys, const std::vector<double> &values, bool alreadySorted = false);
